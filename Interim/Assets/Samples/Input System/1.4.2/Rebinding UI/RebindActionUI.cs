    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            void CleanUp()
            {
                ...
                if (m_RebindErrorText)
                {
                    m_RebindErrorText.text = "";
                }
            }
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if(CheckDuplicateBindings(action, bindingIndex, allCompositeParts))
                        {
                            ...
                            if (m_RebindErrorText)
                            {
                                m_RebindErrorText.text = "Duplicate keybind! Try another.";
                            }
        ...
        // Returns true if there are duplicate keybinds
        bool CheckDuplicateBindings(InputAction action, int bindingIndex, bool allCompositeParts)
        {
        ...
        [SerializeField]
        private Text m_RebindErrorText;
